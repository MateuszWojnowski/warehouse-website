    ...
    <div className={classes.leftdrawer}>
        <ul className={classes.sidedrawer}>
              <Link to="/cargliwice/mainpage" ><Navitem><div className={classes.MainPage}>Strona główna</div></Navitem></Link>               
                  ...
                  <Link to={{ pathname: "https://docs.google.com/forms/d/e/1FAIpQLSeGDk3AipqvADzDue8vUyWgl3ocs74vX6zYWIG-WxAYJG1vyQ/viewform" }} target="_blank"><Navitem>Zgłoś usterkę</Navitem></Link>
              </ul>
    </div>
);
